...
- [x] Right click the email message, drag and drop it on the Tasks icon, and click Move Here as Task with Attachment
...
- [x] Double click the meeting to open its form, and then change the start time and close it
- [ ] None of these answers
...
- [x] Delete the corresponding contact
...
- [x] The server is not on the list of Microsoft approved servers
...
- [x] The meeting organizer will not receive an email with your response, and your response will not be recorded
- [ ] None of these answers
...
#### Q42. You have a contact folder for members and you need to track two additional pieces of member information: start date and last renewal. What is the simplest way to track this information?
...
- [x] The Inbox folder is sorted by size.
...
- [x] The mailbox is a shared mailbox.
...
- [x] Turn on the No Forwarding option.
...
- [x] Right-click the meeting in the Calendar and select Reminders Window.
...
- [x] Highlight the email in the viewing pane and sort by From,
